...
I notice there are some TypeScript errors in the code that need to be fixed. Let me update the code to resolve these errors.

<lov-code>
Let's update the TeamMembersList component to properly type the profile data:

<lov-write file_path="src/components/admin/team/TeamMembersList.tsx">
import { useQuery, useMutation, useQueryClient } from "@tanstack/react-query";
import { supabase } from "@/integrations/supabase/client";
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from "@/components/ui/table";
import { RoleSelector } from "./RoleSelector";
